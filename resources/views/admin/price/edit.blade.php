...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Редактировать Прайс лист</h4>
                </div>
            </div>
        ...
        <form action="{{ route('price.update', $price->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <select name="product_id" id="product_id" class="form-control">
                                ...
                                <option @if($product->id == $price->product_id) selected @endif value="{{ $product->id }}">{{ $product->title_ru }} | Родитель: {{ $product->title_ru }}</option>
                                @endforeach
                            </select>
                   ...
                   <div class="row" style="margin-top: 15px">
                    <div class="col-md-6">
                        ...
                        <textarea name="number_people_uz" class="my-editor" id="number_people_uz" cols="30" rows="10">{{ $price->number_people_uz }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="number_people_ru" class="my-editor" id="number_people_ru" cols="30" rows="10">{{ $price->number_people_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="lesson_uz" class="my-editor" id="lesson_uz" cols="30" rows="10">{{ $price->lesson_uz }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="lesson_ru" class="my-editor" id="lesson_ru" cols="30" rows="10">{{ $price->lesson_ru }}</textarea>
                    ...
                    <br><hr style="border:1px solid blue"><br>
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="course_fee_uz" class="my-editor" id="course_fee_uz" cols="30" rows="10">{{ $price->course_fee_uz }}</textarea>
                    ...
                    <br><hr>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="course_fee_ru" class="my-editor" id="course_fee_ru" cols="30" rows="10">{{ $price->course_fee_ru }}</textarea>
                  ...
                  <br><hr style="border:1px solid blue"><br>
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="registration_course_uz" class="my-editor" id="registration_course_uz" cols="30" rows="10">{{ $price->registration_course_uz }}</textarea>
                    ...
                    <br><hr>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="registration_course_ru" class="my-editor" id="registration_course_ru" cols="30" rows="10">{{ $price->registration_course_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_ru" class="form-control" id="meta_title_ru" cols="30" rows="10">{{ $price->meta_title_ru }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_ru" class="form-control" id="meta_description_ru" cols="30" rows="10">{{ $price->meta_description_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_uz" class="form-control" id="meta_title_uz" cols="30" rows="10">{{ $price->meta_title_uz }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_uz" class="form-control" id="meta_description_uz" cols="30" rows="10">{{ $price->meta_description_uz }}</textarea>
